...
#original buggy code was to print the value myEncryptedMessage, so the program didn't show the decrypted message once it was encrypted. It was fixed by changing the value to myDecryptedMessage
